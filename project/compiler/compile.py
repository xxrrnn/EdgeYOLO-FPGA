...
Usage:
    python project/compiler/compile.py --network yolov5n --out test/network/output/yolov5n
    python project/compiler/compile.py --network resnet18 --out test/network/output/resnet18 --max-layers 3
...
NETWORK_CONFIG = {
    "yolov5n": {
        "parsed_dir":  "project/model/yolov5n_coco50k_qat/parsed_int8",
        "parsed_dir_int16": "project/model/yolov5n_coco50k_qat/parsed_int16",
        "weight_key":  "weight_int8",
    },
    "resnet18": {
        "parsed_dir":  "project/model/resnet18/parsed_vai",
        "parsed_dir_int16": "project/model/resnet18/parsed_int16",
        "weight_key":  "weight_int8",
    },
}
