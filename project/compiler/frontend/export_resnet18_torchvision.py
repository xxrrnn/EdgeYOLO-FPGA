...
Output:
    project/model/resnet18/resnet18_w8a8.onnx   <- QDQ-format quantized ONNX
    project/model/resnet18/resnet18-v1-7.onnx.bak (original FP32, if not already present)
...
def main():
    ...
    ap.add_argument("--output", default=str(REPO / "project/model/resnet18/resnet18_w8a8.onnx"))
    ap.add_argument("--fp32-output", default=str(REPO / "project/model/resnet18/resnet18_fp32.onnx"))
    ...
    zoo_onnx = repo / "project/model/resnet18/resnet18-v1-7.onnx"
