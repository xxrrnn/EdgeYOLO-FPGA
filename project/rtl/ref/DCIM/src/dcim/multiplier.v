...
module multiplier #(
	...
	// Data-only pipeline state is qualified by the separate valid pipeline.
	// Leaving it unreset also keeps the LUT and DSP implementations structurally
	// aligned without broadcasting reset to every multiplier input register.
