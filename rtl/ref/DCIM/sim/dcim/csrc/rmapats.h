...
extern "C" {
#endif
void  rmaPropagate7_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate18_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate18_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate21_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate22_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate22_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate22_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate23_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate23_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate23_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate38_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate38_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate38_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate40_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate40_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate40_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate41_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate41_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate41_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate42_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate42_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate42_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate43_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate43_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate43_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate44_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate44_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate44_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_p_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_simv_vcs_daidir (UB  * pcode, scalar  val);
void  rmaPropagate45_f_simv_vcs_daidir (UB  * pcode, scalar  val, U  I621, scalar  * I1460, U  did);
void  rmaPropagate45_r_simv_vcs_daidir (UB  * pcode);
void  rmaPropagate45_wn_simv_vcs_daidir (UB  * pcode, scalar  val);
