...
module DCIM_Array #(
    ...
    assign tile_ibuf_ext_douta = 0;
    assign tile_ibuf_ext_douta_valid = 0;
    assign tile_obuf_ext_douta = 0;
    assign tile_obuf_ext_douta_valid = 0;
    reg [2:0] cnt;
