...
module tb_dqa_relu_unit;
    ...
    //==========================================================================
    // DUT: dqa_relu_unit (uses real int32_2_fp32_array internally)
    //==========================================================================
    dqa_relu_unit #(
    ...
    always @(posedge clk) begin
        if (gb_enb && gb_web == 0 && dut.c_state == dut.DQA_LOAD_X)
            $display("  [DQA_RELU RD] iter=%0d: addr=%0d (SRC)", mon_iter, gb_addrb);
        if (gb_enb && gb_web != 0 && dut.c_state == dut.DQA_SAVE) begin
            $display("  [DQA_RELU WR] iter=%0d: addr=%0d (DST), save_cnt=%0d",
    ...
    initial begin
        $display("\n======================================================================");
        $display("       dqa_relu_unit Testbench - Real IP, FP32 Mode");
        $display("======================================================================\n");
        ...
        $display("\n======================================================================");
        $display("                   dqa_relu_unit Test Summary");
        $display("======================================================================");
