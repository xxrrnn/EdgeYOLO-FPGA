...
module ibuf #(
  ...
  parameter NBPIPE    = 2,   // Number of pipeline Registers
  parameter NUM_BANKS = 4,   // Number of parallel banks
  parameter IN_REG    = 1    // Input register stage (0=none, 1=one stage)
) ( 
    input clk,
...
// 内部信号
wire [NUM_COL-1:0] wea_int;
wire mem_ena_int;
wire [DWIDTH-1:0] dina_int;
wire [AWIDTH-1:0] addra_int;

wire [NUM_COL-1:0] web_int;
wire mem_enb_int;
wire [DWIDTH-1:0] dinb_int;
wire [AWIDTH-1:0] addrb_int;

generate
if (IN_REG > 0) begin : gen_in_reg
...
// Bank 选择信号
// ============================================================================
wire [BANK_BITS-1:0] bank_sel_a = addra_int[AWIDTH-1 -: BANK_BITS];
wire [BANK_BITS-1:0] bank_sel_b = addrb_int[AWIDTH-1 -: BANK_BITS];
wire [BANK_AWIDTH-1:0] bank_addr_a = addra_int[BANK_AWIDTH-1:0];
wire [BANK_AWIDTH-1:0] bank_addr_b = addrb_int[BANK_AWIDTH-1:0];
