...
DCIM_INT8_ACC_WIDTH = 32
DCIM_INT16_ACC_WIDTH = 64
DCIM_INT8_RESULTS_PER_WORD = DCIM_BUF_DATA_WIDTH // DCIM_INT8_ACC_WIDTH
DCIM_INT16_RESULTS_PER_WORD = DCIM_BUF_DATA_WIDTH // DCIM_INT16_ACC_WIDTH
# Compatibility alias for the established INT8/INT32 accumulator layout.
RESULTS_PER_WORD = DCIM_INT8_RESULTS_PER_WORD
DCIM_INT8_OUT_CH_PER_TILE = DCIM_CH_OUT // 2
DCIM_INT16_OUT_CH_PER_TILE = DCIM_CH_OUT // 4
DCIM_INT8_OUT_WORDS_PER_TILE = (
    DCIM_INT8_OUT_CH_PER_TILE + DCIM_INT8_RESULTS_PER_WORD - 1
) // DCIM_INT8_RESULTS_PER_WORD
DCIM_INT16_OUT_WORDS_PER_TILE = (
    DCIM_INT16_OUT_CH_PER_TILE + DCIM_INT16_RESULTS_PER_WORD - 1
...
def require_consistent() -> None:
    ...
    if DCIM_BUF_DATA_WIDTH % DCIM_INT8_ACC_WIDTH:
        raise ValueError("DCIM buffer word cannot hold an integer number of INT8/INT32 accumulators")
    if DCIM_BUF_DATA_WIDTH % DCIM_INT16_ACC_WIDTH:
        raise ValueError("DCIM buffer word cannot hold an integer number of INT16/INT64 accumulators")
    if DCIM_CH_OUT % 4:
        raise ValueError("DCIM_CH_OUT must be divisible by 4 for native INT16 output channels")
    if DCIM_INT16_OUT_WORDS_PER_TILE * DCIM_INT16_RESULTS_PER_WORD != DCIM_INT16_OUT_CH_PER_TILE:
        raise ValueError("native INT16 tile output layout must be dense INT64 accumulators")
