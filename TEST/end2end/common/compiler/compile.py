...
Usage:
    python TEST/end2end/common/compiler/compile.py --network yolov5n --out output/yolov5n
    python TEST/end2end/common/compiler/compile.py --network resnet18 --out output/resnet18 --max-layers 3
...
END2END_ROOT = Path(__file__).resolve().parents[2]
...
NETWORK_CONFIG = {
    "yolov5n": {
        "parsed_dir":  "TEST/end2end/yolo/model/parsed_int8",
        "parsed_dir_int16": "TEST/end2end/yolo/model/parsed_int16",
        "weight_key":  "weight_int8",
    },
    "resnet18": {
        "parsed_dir":  "TEST/end2end/resnet/model/parsed_vai",
        "parsed_dir_int16": "TEST/end2end/resnet/model/parsed_vai_int16_widened",
        "weight_key":  "weight_int8",
    },
}
...
def main():
    ...
    ap.add_argument("--hw-caps", default=str(Path(__file__).resolve().parent / "lowering" / "hw_caps.yaml"),
