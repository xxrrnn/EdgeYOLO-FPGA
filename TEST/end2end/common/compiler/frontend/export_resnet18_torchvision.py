...
Output:
    TEST/end2end/resnet/model/resnet18_w8a8.onnx   <- QDQ-format quantized ONNX
    TEST/end2end/resnet/model/resnet18-v1-7.onnx.bak (original FP32, if not already present)
...
RESNET_MODEL = REPO / "TEST" / "end2end" / "resnet" / "model"
...
def main():
    ...
    ap.add_argument("--output", default=str(RESNET_MODEL / "resnet18_w8a8.onnx"))
    ap.add_argument("--fp32-output", default=str(RESNET_MODEL / "resnet18_fp32.onnx"))
    ...
    zoo_onnx = RESNET_MODEL / "resnet18-v1-7.onnx"
