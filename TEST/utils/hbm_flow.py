...
try:
    from .xdma_win import (
        ...
        HBM_OFF_WB, HBM_OFF_WEIGHT, TILE_IBUF_BASE, TILE_IBUF_SIZE,
        TILE_OBUF_BASE, TILE_OBUF_SIZE, VPU_BUF_BASE, VPU_BUF_SIZE,
        WB_BASE, WB_SIZE, TILE_OBUF_CHK_SENTINEL, DCIM_NUM_TILES,
        DCIM_INT8_OUT_WORDS_PER_TILE, hex_to_bin, parse_inst_words,
        inst_words_to_bin,
    )
except ImportError:
    from xdma_win import (
