...
COMPILER = REPO / "tests" / "chip" / "compiler" / "compile.py"

CASES = (
    ("yolo_coco_int8", "yolov5n", "int8", "model/yolov5n_coco50k_qat/parsed_int8"),
    ("yolo_coco_int16_native", "yolov5n", "int16", "model/yolov5n_coco50k_qat/parsed_int16"),
    ("resnet18_int8", "resnet18", "int8", "model/resnet18/parsed_vai"),
    ("resnet18_int16_widened", "resnet18", "int16", "model/resnet18/parsed_vai_int16_widened"),
)
