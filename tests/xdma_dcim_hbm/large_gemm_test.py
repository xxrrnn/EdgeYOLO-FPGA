...
# Address map
IBUF_BASE = 0x200000000
OBUF_BASE = 0x200010000
CDMA_BASE = 0x200020000
PE_CFG0_BASE = 0x200030000
PE_CFG1_BASE = 0x200031000
PE_CFG2_BASE = 0x200032000
PE_CFG3_BASE = 0x200033000
PE_CTRL_BASE = 0x200034000
PE_STATUS_BASE = 0x200035000
