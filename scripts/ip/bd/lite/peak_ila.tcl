# ==============================================================================
# peak_ila.tcl - Minimal ILA for streamed INT8 array peak evidence
# ==============================================================================
# Intended workload:
#   M=64, K=64, N=128, acc_depth=1, tile_mask=8'hFF, clk=250 MHz
#
# Evidence:
#   probe0 == 8'hFF for 128 consecutive samples (64 jobs at II=2)
...
#   probe2/probe3 identify the pixel job and INT8/INT16 phase.
#   probe4/probe5 show one final host-visible result for correctness.
#
...
puts "INFO: peak_tops_ila created: mask+input+job+phase+result_valid+result depth=1024"
