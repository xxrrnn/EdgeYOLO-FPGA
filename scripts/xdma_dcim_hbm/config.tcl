# XDMA + DCIM + HBM project configuration.
...
set projName "xdma_dcim_hbm"
set bdName "xdma_dcim_hbm"
set topName "${bdName}_wrapper"

set xdma_dcim_hbmScriptDir [file dirname [file normalize [info script]]]
set scriptsDir [file normalize "$xdma_dcim_hbmScriptDir/.."]
...
set ipBdDir [file normalize "$scriptsDir/ip/bd/xdma_dcim_hbm"]
