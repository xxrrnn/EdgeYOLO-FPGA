...
RESNET_DIR = REPO_ROOT / "project" / "model" / "resnet18"
...
ONNX_VAI = (REPO_ROOT / "project" / "model" / "algorithm" / "Resnet18-quantization"
...
def prepare_vai_int16() -> Path:
    ...
    if not _weights_ready(PARSED_VAI):
        raise FileNotFoundError(
            ...
            "project/model/resnet18/parsed_vai from the release checkout."
        )
