...
sys.path.insert(0, str(_REPO / "project" / "rtl" / "tb" / "lite_bd" / "module_tb"))
sys.path.insert(0, str(_REPO / "project" / "runtime"))
...
# ─── 常量 ──────────────────────────────────────────────────────────────────
_NETWORK_JSON = str(_REPO / "project" / "model" / "yolov5n" / "parsed" / "network.json")
