...
dump("yolo", r"test/network/output/compiled/80832ec_attempt1/yolo_coco_int8/plan.json")
dump("resnet", r"test/network/output/compiled/80832ec_attempt1/resnet18_int8/plan.json")
