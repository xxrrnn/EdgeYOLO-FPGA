...
UNIT_TB_DIR = REPO_ROOT / "test" / "network" / "host"
DEFAULT_RUN_DIR = REPO_ROOT / "test" / "tops" / "output" / "fpga_peak_int8"
...
def main() -> int:
    ...
    if args.report_only:
        ...
        runtime_dir = REPO_ROOT / "project" / "runtime"
        for extra in (runtime_dir, UNIT_TB_DIR):
