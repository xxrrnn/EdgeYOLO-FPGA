...
sys.path.insert(0, str(REPO / "project" / "rtl" / "tb" / "lite_bd" / "module_tb"))
sys.path.insert(0, str(REPO / "test" / "network" / "host"))
...
OUT_DIR = REPO / "test" / "tops" / "output" / "simulation" / "yolo_two_job"
