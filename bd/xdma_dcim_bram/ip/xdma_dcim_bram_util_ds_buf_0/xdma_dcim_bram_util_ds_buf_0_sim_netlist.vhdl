...
-- Date        : Wed Apr 29 20:20:52 2026
-- Host        : DESKTOP-5NNBJ0V running 64-bit Ubuntu 22.04.1 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/triton/task/YOLO_on_FPGA/fpga/EdgeYOLO-FPGA/bd/xdma_dcim_bram/ip/xdma_dcim_bram_util_ds_buf_0/xdma_dcim_bram_util_ds_buf_0_sim_netlist.vhdl
-- Design      : xdma_dcim_bram_util_ds_buf_0
...
entity xdma_dcim_bram_util_ds_buf_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "ibufdsgte4";
  attribute C_MODE : string;
  attribute C_MODE of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of xdma_dcim_bram_util_ds_buf_0_util_ds_buf : entity is "util_ds_buf";
end xdma_dcim_bram_util_ds_buf_0_util_ds_buf;

architecture STRUCTURE of xdma_dcim_bram_util_ds_buf_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xdma_dcim_bram_util_ds_buf_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of xdma_dcim_bram_util_ds_buf_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of xdma_dcim_bram_util_ds_buf_0 : entity is "xdma_dcim_bram_util_ds_buf_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of xdma_dcim_bram_util_ds_buf_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of xdma_dcim_bram_util_ds_buf_0 : entity is "util_ds_buf,Vivado 2024.2.2";
end xdma_dcim_bram_util_ds_buf_0;

architecture STRUCTURE of xdma_dcim_bram_util_ds_buf_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN xdma_dcim_bram_util_ds_buf_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN xdma_dcim_bram_util_ds_buf_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.xdma_dcim_bram_util_ds_buf_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
