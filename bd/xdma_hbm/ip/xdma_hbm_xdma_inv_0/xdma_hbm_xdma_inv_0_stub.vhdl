...
--               /home/triton/task/YOLO_on_FPGA/fpga/local/bd/xdma_hbm/ip/xdma_hbm_xdma_inv_0/xdma_hbm_xdma_inv_0_stub.vhdl
...
entity xdma_hbm_xdma_inv_0 is
  ...
  attribute CORE_GENERATION_INFO of xdma_hbm_xdma_inv_0 : entity is "xdma_hbm_xdma_inv_0,util_vector_logic_v2_0_4_util_vector_logic,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=util_vector_logic,x_ipVersion=2.0,x_ipCoreRevision=4,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_OPERATION=not,C_SIZE=1}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of xdma_hbm_xdma_inv_0 : entity is "yes";
end xdma_hbm_xdma_inv_0;

architecture stub of xdma_hbm_xdma_inv_0 is
