...
-- Command     : write_vhdl -force -mode funcsim -rename_top xdma_hbm_hbm_ref_clk_0_wiz_0 -prefix
--               xdma_hbm_hbm_ref_clk_0_wiz_0_ xdma_hbm_hbm_ref_clk_0_wiz_0_sim_netlist.vhdl
...
entity xdma_hbm_hbm_ref_clk_0_wiz_0_xdma_hbm_hbm_ref_clk_0_wiz_0_clk_wiz is
  port (
...
end xdma_hbm_hbm_ref_clk_0_wiz_0_xdma_hbm_hbm_ref_clk_0_wiz_0_clk_wiz;

architecture STRUCTURE of xdma_hbm_hbm_ref_clk_0_wiz_0_xdma_hbm_hbm_ref_clk_0_wiz_0_clk_wiz is
  signal clk_in1_xdma_hbm_hbm_ref_clk_0_wiz_0 : STD_LOGIC;
  signal clk_out1_xdma_hbm_hbm_ref_clk_0_wiz_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_xdma_hbm_hbm_ref_clk_0_wiz_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_xdma_hbm_hbm_ref_clk_0_wiz_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_xdma_hbm_hbm_ref_clk_0_wiz_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_xdma_hbm_hbm_ref_clk_0_wiz_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xdma_hbm_hbm_ref_clk_0_wiz_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of xdma_hbm_hbm_ref_clk_0_wiz_0 : entity is true;
end xdma_hbm_hbm_ref_clk_0_wiz_0;

architecture STRUCTURE of xdma_hbm_hbm_ref_clk_0_wiz_0 is
begin
inst: entity work.xdma_hbm_hbm_ref_clk_0_wiz_0_xdma_hbm_hbm_ref_clk_0_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
