...
(* CORE_GENERATION_INFO = "xdma_bram,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=xdma_bram,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "xdma_bram.hwdef" *) 
module xdma_bram
   (cpu_reset,
    pci_express_x8_rxn,
    pci_express_x8_rxp,
  ...
  wire [31:0]xdma_bram_axil_ctrl_0_bram_addr;
  wire [255:0]xdma_bram_axil_ctrl_0_bram_din;
  wire xdma_bram_axil_ctrl_0_bram_en;
  wire [31:0]xdma_bram_axil_ctrl_0_bram_we;
  wire [255:0]xdma_bram_doutb;
  ...
  xdma_bram_xdma_bram_0 xdma_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(xdma_bram_axil_ctrl_0_bram_addr),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(xdma_0_axi_aclk),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(xdma_bram_axil_ctrl_0_bram_din),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(xdma_bram_doutb),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(xdma_bram_axil_ctrl_0_bram_en),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(bram_inv_Res),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(xdma_bram_axil_ctrl_0_bram_we));
  xdma_bram_xdma_bram_axil_ctrl_0_0 xdma_bram_axil_ctrl_0
       (.aclk(xdma_0_axi_aclk),
        .aresetn(xdma_0_axi_aresetn),
        .bram_addr(xdma_bram_axil_ctrl_0_bram_addr),
        .bram_din(xdma_bram_axil_ctrl_0_bram_din),
        .bram_dout(xdma_bram_doutb),
        .bram_en(xdma_bram_axil_ctrl_0_bram_en),
        .bram_we(xdma_bram_axil_ctrl_0_bram_we),
